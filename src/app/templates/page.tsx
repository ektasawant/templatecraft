...
import { getTemplates, createTemplate } from "@/lib/domain/templates/store";
...
export default function TemplatesPage() {
  ...
  const [templates, setTemplates] = useState<Template[]>(() =>
    typeof window === "undefined" ? [] : getTemplates()
  );
  ...
  useEffect(() => {
    ...
    // refresh data once on hydration
      ...
      <header className="border-b border-border bg-card/80 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary/90 transition"
          >
